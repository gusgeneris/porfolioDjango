"""
Django settings for porfolioDjango project.
...
ALLOWED_HOSTS = ['gustavodev-1qyh.onrender.com/']
...
ROOT_URLCONF = 'porfolioDjango.urls'
...
WSGI_APPLICATION = 'porfolioDjango.wsgi.application'
